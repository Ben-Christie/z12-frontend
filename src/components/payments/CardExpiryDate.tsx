...
const CardExpiryDate = ({title, changeHandler, paddingTop, paddingBottom, marginBottom}: Props) => {
  ...
  return (
    <div className={classNames('flex', 'flex-col', 'px-10', paddingTop, paddingBottom, 'font-bold', `${marginBottom}`)}>
