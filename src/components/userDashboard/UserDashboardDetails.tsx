...
const UserDashboardDetails = () => {
  ...
  const unpackDetailArrays = (title: string, array: string[]): JSX.Element => {
    ...
    return (
      <div className="border-2 rounded-lg col-span-8 row-span-1 ml-2 grid grid-cols-4 mt-1">
  ...
  return (
    <div className="rounded-lg p-6 mt-5 mb-5 col-span-8 row-span-2 bg-z12-gray grid grid-cols-11 grid-rows-5">
      <div className="rounded-lg border-2 row-span-5 col-span-3 mr-2"></div>

      <div className="border-2 rounded-lg row-span-3 col-span-8 ml-2 grid grid-cols-6 grid-rows-3 mb-1">
