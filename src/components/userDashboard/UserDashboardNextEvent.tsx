...
const UserDashboardNextEvent = () => {
  ...
  return (
    <div className="rounded-lg p-3 mt-7 mb-7 col-span-8 bg-z12-gray flex justify-center items-center">
      <div className="border-2 grid grid-cols-4 w-full h-full rounded-lg p-4 content-center">
